...
const { category_log }  = require('./../controllers')
const { createController, findManyController, findOneController, updateController, deleteController, countController, duplicateController } = category_log
 
const router = express.Router()

const resource = 'category_log'
